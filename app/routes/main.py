"""Home, appointment rescheduling and health endpoints."""
from datetime import date, time
from decimal import Decimal, InvalidOperation

from flask import Blueprint, abort, redirect, render_template, request, url_for

from app.models import CONSULTATION, FARM_VISIT, Appointment, db
...
@main_bp.route("/appointments/<int:appointment_id>/reschedule", methods=["GET", "POST"])
